 ...
 * Se connecte au serveur de don
 nées MySql à partir de valeurs
...
function obtenirMoisVisiteur() {
    $rem = "select distinct fichefrais.mois as mois from  fichefrais order by fichefrais.mois desc ";
    return $rem ;
	}
 
function obtenirReqIdFicheFrais() {
    $rev = "select Visiteur.nom as nom, visiteur.id as id, Visiteur.prenom as prenom from visiteur";
    return $rev ;
}  
